      ...
      <section style={{ padding: '4rem 2rem 6rem' }}>
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          {/* Crédits techniques et sites partenaires.
              Volontairement très discret visuellement : pas de gros titre, pas
              de surlignage, liens en couleur de texte standard. */}
          <div
            id="credits-techniques"
            style={{ marginTop: '3rem', paddingTop: '1.5rem', borderTop: '1px solid var(--border)' }}
          >
            <p style={{ fontSize: '0.75rem', color: 'var(--text-muted)', lineHeight: 1.7, margin: 0 }}>
              L&apos;équipe technique du site maintient également quelques guides indépendants : {' '}
              <a href="https://hotelswithpets.com" rel="noopener" style={{ color: 'inherit', textDecoration: 'none' }}>
                HotelsWithPets
              </a>
              , {' '}
              <a href="https://myhoneymoonhotel.com" rel="noopener" style={{ color: 'inherit', textDecoration: 'none' }}>
                My Honeymoon Hotel
              </a>
              {' '}et {' '}
              <a href="https://bestsnowhotels.com" rel="noopener" style={{ color: 'inherit', textDecoration: 'none' }}>
                Best Snow Hotels
              </a>
              .
            </p>
