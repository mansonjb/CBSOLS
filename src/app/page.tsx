...
const garanties = [
  ...
  { title: "Plus de 25 ans d'expertise", desc: "Fondé en 1999. Plus de 500 projets à La Rochelle, l'Île de Ré et en Charente-Maritime.", icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round"><polygon points="12,2 15.09,8.26 22,9.27 17,14.14 18.18,21.02 12,17.77 5.82,21.02 7,14.14 2,9.27 8.91,8.26"/></svg> },
...
const homeFaqSchema = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: "CB Sols intervient-il sur l'Île de Ré et l'Île d'Oléron ?", acceptedAnswer: { '@type': 'Answer', text: "Oui, régulièrement. CB Sols équipe des hôtels, campings et résidences sur les deux îles depuis plus de 25 ans. Les contraintes insulaires sont parfaitement intégrées dans les devis et plannings." } },
  ],
}
    ...
    <>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '5rem', alignItems: 'center', minHeight: 'calc(100vh - 72px)', paddingTop: '3rem', paddingBottom: '4rem' }} className="hero-grid">
            ...
            <div>
              ...
              <p style={{ fontSize: 'clamp(0.9rem, 1.2vw, 1.05rem)', color: 'var(--dark-2)', lineHeight: 1.7, maxWidth: '440px', margin: '0 0 2.5rem' }}>
                Moquette, sol PVC, tapis sur mesure : CB Sols accompagne particuliers, hôtels et entreprises en Charente-Maritime depuis <strong>plus de 25 ans</strong>.
              </p>
              ...
              <div style={{ display: 'flex', gap: '0', marginTop: '4rem', paddingTop: '2rem', borderTop: '1px solid var(--border)', flexWrap: 'wrap' }}>
                {[{ v: 'plus de 25', l: "ans d'expérience" }, { v: '500+', l: 'projets réalisés' }, { v: '49', l: 'communes couvertes' }, { v: '4.9/5', l: 'note Google' }].map((s) => (
      ...
      <section style={{ padding: '0', overflow: 'hidden' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '4px', backgroundColor: 'var(--bg-inv)' }} className="materials-grid">
          {[
            { img: '/images/moquette-bureau.webp', label: 'Moquette', caption: 'Laine & synthétique : hôtellerie, bureaux, résidentiel', href: '/services/pose-moquette', brand: 'EGE' },
            ...
            <div>
              {[
                ...
                },
                {
                  ...
                  a: "Oui, régulièrement. CB Sols équipe des hôtels, campings et résidences sur les deux îles depuis plus de 25 ans. Les contraintes insulaires (logistique, hygrométrie, saisonnalité) sont parfaitement intégrées dans nos devis et plannings."
                },
              ].map((item, i) => (
