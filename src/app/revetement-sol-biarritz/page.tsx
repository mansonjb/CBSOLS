...
const materiaux = [
  ...
  { name: "Sisal scellé pour résidences contemporaines", desc: "Dans une villa moderne face océan, le sisal scellé apporte ce côté brut qu'on cherche. C'est en accord parfait avec l'esprit Côte Basque, les bois flottés, les enduits naturels. Coloris chinés sable, écru, taupe doux. Ça encaisse un usage familial classique et le sable rapporté de la plage." },
]
