...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Sol PVC conforme PMI pour crèche, micro-crèche et MAM. Sans phtalates, label A+, acoustique, glissance R10/R11, antibactérien intégré.",
    type: 'website',
...
const produits = [
  { name: 'Sol PVC acoustique petite enfance', desc: "Référence des sections bébés et dortoirs : Gerflor Taralay Acoustic, Tarkett iQ Granit Acoustic, Forbo Sarlon Habitat, Tarkett Acczent Excellence Acoustic. Amélioration du bruit d'impact de 17 à 22 dB, label A+, classement U3P3 ou U4P3 selon zone, sans phtalates de génération précédente." },
  { name: 'Sol PVC compact sans phtalates', desc: "Pour les structures les plus exigeantes ou démarche HQE : Gerflor Mipolam Symbioz (bio-attribué), Forbo Sphera (totalement sans phtalates), Tarkett iQ Granit (100% recyclable circuit fermé). Compact homogène ponçable, durée de vie 25 ans, label A+." },
  { name: 'Sol PVC sécurité change et sanitaires', desc: "Pour salle de change, sanitaires et biberonnerie : Gerflor Tarasafe Standard, Polyflor Acoustix Forest fx, Forbo Surestep, Altro XpressLay. Glissance R11, granulats anti-glisse dans la couche d'usure, plinthes à gorge associées, conformité PMI." },
]
    ...
    '@graph': [
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 2, name: 'Sol PVC crèche', item: 'https://cbsols.fr/sol-pvc-creche' },
        ],
      },
    ],
  }
      ...
      <section style={{ padding: '4rem 2rem', borderBottom: '1px solid var(--border)', backgroundColor: 'var(--bg-alt)' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
          ...
          <p style={{ fontSize: '0.9rem', color: 'var(--muted)', lineHeight: 1.7, maxWidth: '780px', marginBottom: '1.5rem' }}>
            CB Sols intervient sur l&apos;ensemble du cycle éducatif, de la petite enfance au lycée. Une même rigueur ERP et conformité du dossier à la pose.
          </p>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(220px, 1fr))', gap: '1rem' }}>
            ...
            <Link href="/sol-pvc-college-lycee" style={{ padding: '1.25rem', border: '1px solid var(--border)', borderRadius: '10px', backgroundColor: 'var(--bg-card)', textDecoration: 'none', color: 'var(--dark)', fontWeight: 600, fontSize: '0.9rem' }}>Sol PVC collège lycée →</Link>
