...
const exigences = [
  { title: "Résistance au sable, partout", desc: "Le sable s'invite partout au Cap Ferret. Dans les chaussons, sous les pieds, dans les ourlets de pantalon, dans les sacs de plage. Un revêtement de sol qui n'est pas pensé pour cette réalité s'use deux fois plus vite, perd sa tenue visuelle, devient impossible à entretenir. Nos préconisations intègrent systématiquement cette donnée centrale du Bassin." },
  { title: "Humidité saline et air marin", desc: "L'air du Bassin charge en sel et en humidité, surtout en hiver et hors saison. Les fibres naturelles non traitées s'altèrent, les colles d'usage standard perdent en tenue, les sous-couches absorbent l'humidité ambiante. Nous sélectionnons des fibres synthétiques anti-UV, des colles compatibles bord de mer et des sous-couches techniques fermées." },
  { title: "Saisonnalité d'usage, ouvert/fermé", desc: "Beaucoup de villas du Cap Ferret restent fermées plusieurs mois par an. Cette alternance ouvert/fermé impose un revêtement qui supporte les variations de température et d'humidité sans gondoler, sans décoller, sans perdre de tenue. Nous proscrivons les colles à séchage long et les matières trop sensibles aux écarts thermiques." },
  { title: "Fibres synthétiques compatibles bord de mer", desc: "Polyamide haute densité, polypropylène anti-UV, fibres tissées vinyle type Bolon. Ces familles offrent la meilleure résistance combinée au sable, au sel, aux UV et à l'usage soutenu en saison. Pour les chambres parentales où le confort tactile prime, on peut introduire de la laine vierge traitée, en équilibre avec la résistance attendue." },
  { title: "Intervention saisonnière hors juillet-août", desc: "Le Cap Ferret se transforme en été : circulation impossible, livraisons saturées, vie de famille concentrée. Nous calons systématiquement nos interventions hors saison, idéalement entre septembre et juin, avec un pic en mai-juin (avant ouverture saison) et septembre-octobre (après fermeture). Cette planification protège le calendrier de tous." },
  { title: "Accès villas et ruelles de village", desc: "Les villages du Cap Ferret, L'Herbe, Le Canon, Piraillan, sont des bijoux de ruelles étroites et de cabanes ostréicoles serrées. L'accès en camion est souvent impossible jusqu'à la villa. Nous prévoyons la manutention à la main, les diables larges sur sable, la protection des terrasses bois et le respect strict des espaces communs entre cabanes." },
]
