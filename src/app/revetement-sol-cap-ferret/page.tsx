...
const exigences = [
  ...
  { title: "Maison fermée six mois, nous prenons en charge", desc: "Beaucoup de villas restent closes hors saison. La chaleur monte, l'humidité varie, le sol travaille. On évite les colles trop lentes et les matières fragiles aux écarts. Vous ouvrez la maison en juin, tout est en place comme le jour de la pose." },
...
const materiaux = [
  { name: "Bolon tissé vinyle haut de gamme", desc: "Notre matière de prédilection pour le bord du Bassin. Le sable s'essuie simplement à l'eau, le sel ne l'abîme pas. Les coloris naturels (lin, sable, écru) s'inscrivent parfaitement dans une villa du Cap. On la pose dans les entrées et les couloirs. Compter quinze à vingt ans en usage saisonnier, avec un entretien immédiat." },
...
const marques = [
  { name: "Gerflor", desc: "Le français de Lyon, que nous connaissons en profondeur. Leur Texline est parfaite pour les zones humides et les espaces saisonniers. Elle résiste au sable et à l'humidité année après année." },
...
const faq = [
  { q: "Vous venez vraiment au Cap Ferret depuis La Rochelle ?", a: "Oui, sans difficulté. Le Cap est à 2h30 de notre atelier par l'autoroute. Nous maîtrisons cette distance depuis vingt-sept ans avec les chantiers de Ré et d'Oléron, la logique est exactement la même. On vient mesurer une première fois, puis on revient poser. L'hébergement est inclus dans le devis. On évite juillet et août, on cale en mai-juin avant l'ouverture ou en septembre-octobre après la fermeture." },
  { q: "Quel revêtement choisir pour une villa pieds dans le sable ?", a: "Le sable s'invite partout, c'est l'ennemi numéro un d'un sol au Cap. Dans les entrées et les couloirs, on part sur du Bolon tissé vinyle ou du Gerflor Texline. L'entretien se fait à l'eau, le matériau vieillit bien face au sel. Dans les chambres et les bibliothèques, où vous voulez du moelleux sous les pieds, on remet du polyamide haute densité ou de la laine traitée. On cale l'arbitrage avec vous à la visite." },
...
export default function RevetementSolCapFerretPage() {
  ...
  return (
    <div style={{ paddingTop: '72px' }}>
      <StickyDevisButton from="cap-ferret" />
        ...
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
          <div style={{ borderLeft: '3px solid var(--terra)', paddingLeft: '2rem' }}>
            <p style={{ fontFamily: 'var(--font-serif)', fontStyle: 'italic', fontSize: 'clamp(1.2rem, 2.2vw, 1.6rem)', color: 'var(--dark)', lineHeight: 1.5, margin: '0 0 1.5rem' }}>
              « Une villa du Cap vit en saison et se referme le reste de l&apos;année. Le sol doit accepter ce cycle, supporter le sel, résister au sable. C&apos;est un métier de patience et de bons choix dès le départ. »
            </p>
