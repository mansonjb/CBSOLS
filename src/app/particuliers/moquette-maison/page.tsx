...
const faq = [
  ...
  { q: 'Quelle est la durée de vie d\'une moquette haut de gamme chez un particulier ?', a: "Une moquette contrat (la même que celle posée chez les hôteliers) installée chez un particulier dure 12 à 20 ans selon l'usage. Une moquette résidentielle bas de gamme : 3 à 5 ans. C'est pourquoi nous ne posons que du contrat." },
