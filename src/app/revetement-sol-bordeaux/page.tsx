...
const exigences = [
  ...
  { title: "Deux cents kilomètres, une distance maîtrisée", desc: "Bordeaux est à deux heures de notre atelier par l'A10. On y descend plusieurs fois par mois, on connaît les chantiers du coin. Vous appelez, on vient mesurer dans la semaine. Pas de surcoût caché pour le déplacement." },
...
const materiaux = [
  { name: "Moquette laine vierge tissée Wilton et Axminster", desc: "Notre matière de référence pour les salons d'apparat. La laine se patine, se densifie avec le temps. Au toucher, elle est ferme. À l'œil, elle vieillit noblement. On la pose souvent en uni ou avec un motif géométrique discret pour respecter les boiseries. Compter facilement quinze à vingt ans de tenue." },
  ...
  { name: "Sols PVC effet bois pour échoppes rénovées", desc: "Parfois le parquet d'origine n'est plus récupérable. Plutôt qu'une dépose invasive, on vous propose un PVC effet bois de très belle qualité. Le rendu visuel reste convaincant. La pose est réversible et compatible avec une revente patrimoniale. On peut même le poser sur un chauffage au sol." },
...
const marques = [
  { name: "EGE Carpets", desc: "Le tisseur danois est notre référence pour les salons d'hôtel particulier où la moquette doit s'imposer. On le retrouve souvent dans les grandes maisons et les tables étoilées, les gammes Highline et Hospitality résistent parfaitement à l'usage intensif." },
  { name: "Brintons", desc: "L'Axminster britannique, c'est l'aristocratie de la moquette. On peut tisser jusqu'à trente-six couleurs sur un motif. Quand vous voulez un salon d'apparat qui s'impose, Brintons est la maison à solliciter." },
  ...
  { name: "Gerflor", desc: "Le français de Lyon, que nous connaissons en profondeur. Le choix de coloris est large, leurs imitations bois sont crédibles, et tout se pose sur chauffage au sol. C'est notre référence PVC polyvalente." },
...
const faq = [
  ...
  { q: "Une moquette laine, ça tient combien de temps ?", a: "Compter facilement quinze à vingt ans dans un hôtel particulier à usage privé. La laine vieillit bien : elle se patine, se densifie au lieu de s'écraser. Sur les vestibules et les escaliers, on choisit plutôt une laine tissée serrée avec un motif discret, qui tolère mieux les marques de passage. Un nettoyage professionnel une fois par an suffit à conserver l'aspect du premier jour." },
...
export default function RevetementSolBordeauxPage() {
  ...
  return (
    <div style={{ paddingTop: '72px' }}>
      <StickyDevisButton from="bordeaux" />
