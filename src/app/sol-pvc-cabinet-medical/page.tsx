...
const usages = [
  ...
  { title: "Couloirs et zones de passage", desc: "Vos circulations prennent le plus de coups. On pose un PVC dense à motif chiné qui pardonne les marques. La teinte reste continue entre les pièces. Les seuils n'accrochent pas les roulettes de fauteuils." },
]
...
const faq = [
  ...
  { q: "Peut-on poser sans fermer le cabinet ?", a: "Possible, en organisant le chantier pièce par pièce sur plusieurs semaines, avec un balisage clair entre la zone en travaux et la zone en activité. Ça allonge le chantier global mais évite la fermeture. Ça marche bien sur un centre pluri-professionnel. Pour un cabinet plus petit, c'est souvent plus simple et moins cher de fermer deux à quatre jours sur des congés. On choisit la meilleure stratégie ensemble à la visite." },
  { q: "Quel sol pour un cabinet vétérinaire ?", a: "Le véto, c'est un cahier des charges à part. Il faut antidérapant pour les animaux paniqués ou anesthésiés, lavable à grande eau, résistant aux griffes de chien et de chat, et capable d'encaisser des désinfectants plus agressifs qu'en cabinet humain. On part sur du Forbo Surestep ou du Gerflor Tarasafe. La pose en lés soudés avec remontée en plinthe est quasi-obligatoire en chirurgie et hospitalisation. Le contrôle sanitaire passe ensuite sans souci." },
