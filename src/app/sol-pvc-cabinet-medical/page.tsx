...
const exigences = [
  { title: "Facile à désinfecter", desc: "Le sol se nettoie à l'eau, à l'eau javellisée diluée ou avec un détergent désinfectant classique des établissements de santé. Pas de produit spécifique à commander, pas de précaution particulière. Les soudures à chaud entre les lés rendent la surface continue, sans joint où les bactéries viendraient s'installer. C'est le b.a.-ba d'un sol médical, et le PVC professionnel coche cette case sans difficulté." },
  { title: "Confort acoustique", desc: "Un cabinet calme est un cabinet où le patient se sent en sécurité. Le PVC acoustique réduit la perception des bruits de pas et des conversations dans les pièces voisines, ce qui change radicalement le ressenti en salle d'attente et en consultation. On peut atteindre 17 à 19 dB d'amélioration selon les gammes, sans changer la structure du local." },
  { title: "Air intérieur sain", desc: "Les gammes professionnelles que nous posons sont classées A+ pour les émissions dans l'air intérieur. Concrètement, pas d'odeur résiduelle après la pose, pas de composé volatil qui s'évapore pendant des semaines. Le cabinet peut rouvrir dès le lendemain de la fin du chantier sans inconfort pour les patients sensibles." },
  { title: "Résistance aux roulettes et chariots", desc: "Fauteuils dentaires, sièges de bureau, chariots de soins, tables d'examen mobiles : le sol encaisse beaucoup de roulements concentrés. Les PVC professionnels acceptent ces sollicitations sans marquer, sans creuser, sans déformer la surface. La durée de vie utile dépasse facilement 15 ans en cabinet de consultation classique, plus en zone calme." },
  { title: "Esthétique apaisante", desc: "Un cabinet médical n'a pas vocation à ressembler à un hôpital. Les palettes contemporaines proposent des effets bois clair, des bétons doux, des unis mats dans des tonalités vert d'eau, terre, ocre clair. On compose une ambiance accueillante, en cohérence avec le mobilier, qui rassure le patient dès l'entrée et soutient l'image du praticien." },
  { title: "Mise en œuvre rapide", desc: "Un cabinet ne peut pas rester fermé longtemps. Nos chantiers se calent sur les fermetures classiques : vendredi soir au lundi matin, vacances scolaires, semaine de congés annuels du praticien. Le pré-assemblage en atelier à Villedoux permet de tenir une pose finale en 2 à 4 jours sur la plupart des cabinets, livraison et finitions comprises." },
]
