...
import { Building2, Castle, Home, Mail, MapPin, Pill, Stethoscope, Store } from 'lucide-react'
...
const materiaux = [
  ...
  { name: "Moquette laine vierge tissée Wilton", desc: "Pour les salons des hôtels particuliers du centre historique. La laine se patine en vieillissant, elle ne s'écrase pas. Au toucher elle est ferme, à l'œil elle se distingue. On choisit avec vous un uni ou un motif géométrique discret pour respecter les boiseries." },
  ...
  { name: "Profilés laiton et alu brossé Romus", desc: "Pour les seuils et les nez de marche, on soigne le détail. On coordonne avec votre quincaillerie existante, ce qui compte sur un bâtiment historique. Sur les chantiers tertiaires un peu exigeants, on peut faire fabriquer du sur mesure. C'est le genre de détail qui se remarque à la livraison." },
]

const marques = [
  { name: "Gerflor", desc: "Le français de Lyon, que nous connaissons en profondeur. Leurs PVC Mipolam et Taralay sont notre référence polyvalente sur les grands plateaux de bureaux. Choix large, acoustique sérieuse, entretien simple." },
  { name: "Tarkett", desc: "Pour les open spaces qui demandent un vrai confort acoustique, on part sur du Tarkett iQ Granit. Il vieillit bien et reste notre référence sur les plateaux tertiaires haut de gamme niortais." },
  ...
  { name: "EGE Carpets", desc: "Le tisseur danois, notre référence pour un bureau de direction qui s'impose. Leurs dalles intègrent déjà la sous-couche acoustique, ce qui facilite la pose. On les recommande sur les salles du conseil." },
...
const faq = [
  ...
  { q: "Combien de temps tient un sol PVC sur un plateau de bureaux ?", a: "Compter facilement quinze à vingt ans, parfois plus. Un PVC homogène vieillit bien parce qu'il n'a pas de couche d'usure à percer, c'est le même matériau de haut en bas. Sur les zones très passantes (accueil, couloirs), on prend un classement 34, qui tolère mieux les roulettes. Un nettoyage professionnel une fois par an suffit à conserver l'aspect du premier jour." },
