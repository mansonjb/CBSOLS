...
const exigences = [
  { title: "Tertiaire à grande échelle", desc: "Niort accueille beaucoup de sièges sociaux et de grands plateaux de bureaux. Ce sont des chantiers de plusieurs centaines de mètres carrés, avec un planning serré et des contraintes de phasage en soirée ou le week-end pour ne pas gêner l'activité. CB Sols organise les équipes en conséquence et livre dans les délais annoncés." },
  { title: "Le confort sonore qui fait la différence", desc: "Sur un grand open space, le bruit ambiant change tout : qualité d'échange, fatigue en fin de journée, capacité à se concentrer. Le bon revêtement (dalles moquette avec sous-couche acoustique ou PVC acoustique) divise par deux la sensation de brouhaha. Différence ressentie dès le premier jour." },
  { title: "Respecter les beaux supports anciens", desc: "Le centre historique abrite des immeubles bourgeois et des hôtels particuliers avec parquets d'origine. On y intervient en pose réversible (sous-couche feutre, pas de clouage, pas de colle agressive) pour qu'on puisse retirer la moquette dans dix ans sans abîmer le bois en dessous. Le patrimoine se transmet, on l'aborde dans cet esprit." },
  { title: "Une heure de route, on est là", desc: "Niort est à 80 km de notre atelier de Villedoux, une heure par l'A10. C'est notre zone d'intervention naturelle, on y passe plusieurs fois par mois. Visite de prise de mesures sous une semaine, pose calée selon votre planning. Le déplacement n'est jamais une excuse pour repousser un rendez-vous." },
  { title: "Conformité ERP simplifiée", desc: "Pour les EHPAD, cliniques et établissements recevant du public, la réglementation impose des classements feu précis et des certifications sanitaires. On gère le sujet pour vous : on choisit les produits qui passent (Bfl-s1, certifications adaptées), on fournit les attestations, vous n'avez pas à éplucher des fiches techniques de 40 pages." },
  { title: "Un seul interlocuteur sur tout le chantier", desc: "Sur un projet tertiaire, on travaille souvent avec un responsable des services généraux qui jongle déjà avec dix prestataires. Notre rôle : être l'interlocuteur unique sur tout le sujet sol, du devis à la réception. Comptes-rendus clairs, factures lisibles, attestations à jour. Pas de friction inutile." },
]
