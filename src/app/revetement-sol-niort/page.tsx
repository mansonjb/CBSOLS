...
export const metadata: Metadata = {
  ...
  description: "Pose de moquette, sol PVC et tapis sur mesure à Niort. Hôtels particuliers du centre historique, sièges de mutuelles MAAF MAIF MACIF, restaurants des Halles, EHPAD. CB Sols intervient depuis 27 ans, déplacement régulier depuis Villedoux.",
...
const usages = [
  ...
  { title: "Sièges de mutuelles MAAF, MAIF, MACIF", desc: "Niort est la capitale française des mutuelles d'assurance. Les sièges sociaux et plateaux tertiaires de la MAAF, MAIF, MACIF, IMA et leurs filiales représentent un parc immobilier considérable. Sols PVC acoustiques pour open spaces, dalles moquette pour bureaux de direction, salles du conseil habillées en moquette laine. Coordination avec les services généraux et phasage en horaires décalés." },
...
const exigences = [
  { title: "Pôle assurances mutualistes structurant", desc: "Niort concentre un parc tertiaire mutualiste unique en France. Les exigences des services généraux des mutuelles sont précises : appels d'offres formalisés, fiches techniques complètes, PV feu, certifications environnementales, planning ferme avec phasage en horaires décalés. Notre dossier de candidature et notre documentation matière sont calibrés pour répondre à ces standards." },
  { title: "Patrimoine du centre historique classé", desc: "Le donjon, le quartier Notre-Dame, les Halles, la place de la Brèche structurent un centre historique avec immeubles bourgeois XIXe et hôtels particuliers à préserver. Nos poses respectent les parquets anciens et les supports d'origine, en réversibilité chaque fois que possible, sans clouage ni colle agressive." },
  { title: "Logistique vers les Deux-Sèvres", desc: "Niort se situe à environ 80 km de notre atelier de Villedoux, près de La Rochelle, soit une heure de route par l'A10 ou la N11. C'est une zone d'intervention naturelle et régulière, avec passages plusieurs fois par mois. Visite de prise de cotes organisée sous huitaine, pose programmée selon votre calendrier." },
  { title: "Coordination services généraux et facility", desc: "Sur les chantiers tertiaires, l'interlocuteur est rarement l'utilisateur final mais le responsable des services généraux ou un facility manager externalisé. Nous calons les comptes-rendus de chantier, les bons de livraison, les attestations de fin de travaux et les facturations selon leurs processus, sans friction administrative." },
  { title: "ERP et établissements de santé", desc: "Les EHPAD, cliniques privées et établissements médico-sociaux niortais relèvent du règlement ERP avec exigences fortes sur la réaction au feu, l'hygiène et l'accessibilité. Nos produits sélectionnés disposent des classements Bfl-s1 ou Cfl-s1, des certifications sanitaires et des fiches d'entretien adaptées au protocole bionettoyage." },
  { title: "Acoustique des open spaces tertiaires", desc: "Les plateaux open space des mutuelles peuvent dépasser plusieurs centaines de mètres carrés sous plafond technique. La moquette dalles avec sous-couche acoustique intégrée ou le sol PVC acoustique apportent une chute notable de la réverbération et améliorent le confort de travail mesurable au sonomètre." },
]
...
const materiaux = [
  ...
  { name: "Moquette dalles EGE et Forbo", desc: "Pour les bureaux de direction, salles du conseil et espaces d'accueil des sièges sociaux mutualistes. Format 50×50 cm permettant le remplacement partiel en cas de salissure localisée. Classement 33 commercial intense, sous-couche acoustique, durabilité 15 à 20 ans en bureau." },
...
const marques = [
  { name: "Gerflor", desc: "Sol PVC Mipolam et Taralay, références du tertiaire mutualiste et du médico-social. Gamme acoustique, large choix de coloris, compatible chauffage au sol, entretien simple. Référence pour les sièges sociaux niortais." },
  ...
  { name: "EGE Carpets", desc: "Manufacture danoise référence du contract européen. Gammes Highline et Hospitality pour les bureaux de direction et salles du conseil mutualistes. Dalles avec sous-couche acoustique intégrée." },
  ...
  { name: "Object Carpet", desc: "Manufacture allemande, sols textiles design contemporain. Gammes pour bureaux d'affaires haut de gamme et espaces tertiaires de prestige mutualistes." },
...
const quartiers = [
  ...
  { nom: "Chauray", detail: "Cœur du pôle mutualiste avec sièges sociaux et bâtiments tertiaires majeurs. Open spaces, salles du conseil, bureaux de direction des grandes mutuelles d'assurance." },
...
const process = [
  { step: 'Premier contact', desc: "Échange téléphonique ou par mail. Recueil des éléments clés : type de projet (tertiaire mutualiste, hôtel particulier, EHPAD, restaurant), surface estimée, calendrier souhaité, contraintes ERP éventuelles. Pour les appels d'offres mutualistes, nous récupérons le DCE complet." },
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '3rem', alignItems: 'center' }}>
            <div>
              ...
              <p style={{ fontSize: '1rem', color: 'var(--muted)', maxWidth: '560px', lineHeight: 1.75, marginBottom: '2rem' }}>
                Pose de moquette, sol PVC et tapis sur mesure à Niort. Sièges de mutuelles MAAF, MAIF, MACIF, hôtels particuliers du centre historique, restaurants des Halles, EHPAD et résidences médicalisées. Atelier basé près de La Rochelle, déplacement à Niort organisé chaque mois.
              </p>
      ...
      <section style={{ padding: '5rem 2rem', borderBottom: '1px solid var(--border)' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
          ...
          <p style={{ fontSize: '0.95rem', color: 'var(--muted)', lineHeight: 1.7, maxWidth: '780px', marginBottom: '2rem' }}>
            Intervenir à Niort, ce n&apos;est pas reproduire un chantier standard. Voici les six points sur lesquels nous structurons notre méthode dès la première visite, pour répondre aux exigences mutualistes et tenir le calendrier.
          </p>
        ...
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
          <div style={{ borderLeft: '3px solid var(--terra)', paddingLeft: '2rem' }}>
            <p style={{ fontFamily: 'var(--font-serif)', fontStyle: 'italic', fontSize: 'clamp(1.2rem, 2.2vw, 1.6rem)', color: 'var(--dark)', lineHeight: 1.5, margin: '0 0 1.5rem' }}>
              « Un plateau tertiaire mutualiste à Niort, c&apos;est précisément ce que CB Sols sait faire. La documentation, le phasage, le respect des horaires d&apos;exploitation, et la finition irréprochable au lever du jour. »
            </p>
      ...
      <section style={{ padding: '5rem 2rem', borderBottom: '1px solid var(--border)' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
          ...
          <p style={{ fontSize: '0.95rem', color: 'var(--muted)', lineHeight: 1.7, maxWidth: '780px', marginBottom: '2.5rem' }}>
            Notre équipe se déplace sur l&apos;ensemble de la communauté d&apos;agglomération du Niortais ainsi que sur les communes limitrophes, là où se concentrent les projets résidentiels patrimoniaux, tertiaires mutualistes et médico-sociaux.
          </p>
      ...
      <section style={{ padding: '5rem 2rem', backgroundColor: 'var(--dark)', color: 'var(--bg)' }}>
        <div style={{ maxWidth: '900px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: '1rem', color: 'rgba(248, 245, 238, 0.75)', maxWidth: '600px', margin: '0 auto 2.5rem', lineHeight: 1.75 }}>
            Visite sur place à Niort. Devis détaillé, finitions premium, respect des contraintes mutualistes et patrimoniales. CB Sols, 27 ans de savoir-faire au service des projets d&apos;exception en Deux-Sèvres.
          </p>
