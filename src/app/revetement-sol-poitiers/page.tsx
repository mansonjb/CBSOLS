...
const exigences = [
  { title: "Les labos, on connaît leurs contraintes", desc: "Acides, solvants, équipements sensibles : un sol de labo doit résister à tout. On retient des PVC techniques soudés à chaud, sans joint apparent, faciles à décontaminer. Les attestations vont avec. Vos équipes travaillent sereinement, le bureau de contrôle valide sans souci." },
...
const materiaux = [
  ...
  { name: "Sols PVC écoles privées Forbo et Polyflor", desc: "Pour une école privée, on regarde Forbo Marmoleum (un vrai linoléum à base d'huile de lin, certifié A+ COV) ou du Polyflor pour les zones humides. Tout est classé Bfl-s1, ça encaisse le trafic d'enfants sans souci. On vous fournit le dossier complet pour la commission de sécurité ERP type R." },
...
const marques = [
  ...
  { name: "Tarkett", desc: "Pour les open spaces qui demandent un vrai confort acoustique, on part sur du Tarkett iQ Granit. Ça vieillit bien, c'est notre référence sur les plateaux tertiaires et les plateaux médicaux poitevins." },
