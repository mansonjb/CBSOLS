      ...
      <div style={{ paddingTop: '72px' }}>
        ...
        <section style={{ padding: '5rem 2rem 4rem', borderBottom: '1px solid var(--border)', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ maxWidth: '1280px', margin: '0 auto', position: 'relative' }}>
            ...
            <h1 style={{ fontFamily: 'var(--font-playfair, Georgia, serif)', fontSize: 'clamp(2.5rem, 5vw, 4.5rem)', fontWeight: 400, color: 'var(--cream)', margin: '0 0 1.5rem', letterSpacing: '-0.03em', lineHeight: 1.1 }}>
              ...
              <em style={{ fontStyle: 'italic', color: 'var(--terra)' }}>{cityData.name}</em>
            </h1>
        ...
        <section style={{ padding: '5rem 2rem', backgroundColor: 'var(--bg-card)', borderBottom: '1px solid var(--border)' }}>
          <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
            ...
            <h2 style={{ fontFamily: 'var(--font-playfair, Georgia, serif)', fontSize: 'clamp(1.75rem, 3vw, 2.5rem)', fontWeight: 400, color: 'var(--cream)', margin: '0 0 3rem', letterSpacing: '-0.02em' }}>
              ...
              {services.map((service) => (
                <Link key={service.slug} href={`/${service.slug}-${city}`} style={{ textDecoration: 'none' }}>
                  <div style={{ backgroundColor: 'var(--bg-card)', padding: '2rem', transition: 'background-color 0.2s', height: '100%' }}>
                    <h3 style={{ fontFamily: 'var(--font-playfair, Georgia, serif)', fontSize: '1.1rem', fontWeight: 400, color: 'var(--cream)', margin: '0 0 0.75rem', lineHeight: 1.3 }}>
