...
const projects = [
  { title: 'Hôtel La Baronnie, Île de Ré', type: 'Tapis sur mesure & moquettes chambres', sector: 'Hôtellerie', year: '2025', surface: '600 m²', desc: "Création de tapis sur mesure au motif exclusif pour les espaces communs et chambres. Moquette EGE haut de gamme dans les chambres.", img: '/images/tapis-hotel-real.jpg' },
  { title: 'Bistrot de la Grande Terrasse', type: 'Moquette acoustique salle', sector: 'Restauration', year: '2026', surface: '280 m²', desc: "Rénovation complète du sol de la salle de restaurant. Moquette acoustique pour améliorer le confort sonore des convives.", img: '/images/bistrot-restaurant-real.jpg' },
  { title: 'Restaurant Christopher Coutanceau', type: 'Moquette gastronomique sur mesure', sector: 'Restauration étoilée', year: '2025', surface: '220 m²', desc: "Pose d'une moquette sur mesure dans un restaurant gastronomique de La Rochelle. Couleurs et motifs coordonnés à la décoration intérieure.", img: '/images/restaurant-etoile-real.jpg' },
  { title: 'Golf de la Prée', type: 'Moquette contrat + Sol PVC vestiaires', sector: 'Sport & Loisirs', year: '2023', surface: '600 m²', desc: "Refonte complète des sols du clubhouse avec moquette contrat résistante, et sols PVC étanches dans les vestiaires.", img: '/images/golf-real.jpg' },
  { title: 'Bureaux Charente-Maritime', type: 'Moquette dalles haute résistance', sector: 'Tertiaire', year: '2024', surface: '350 m²', desc: "Pose de moquette dalles adaptées aux chaises à roulettes. Pose le week-end sans interruption d'activité.", img: '/images/moquette-bureau-real.jpg' },
  { title: 'Cuisine Professionnelle', type: 'Sol PVC soudé à chaud', sector: 'Restauration Pro', year: '2024', surface: '80 m²', desc: "Pose de PVC en lés avec soudure à chaud. Aucun joint pour une hygiène maximale, nettoyage intensif facilité.", img: '/images/cuisine-pro-real.jpg' },
  ...
  { title: 'Tapis Hôtel La Baronnie, détail', type: 'Création tapis sur mesure', sector: 'Hôtellerie', year: '2025', surface: 'Motif exclusif', desc: "Motif exclusif créé sur mesure pour l'Hôtel La Baronnie. Design coordonné à l'identité visuelle de l'établissement.", img: '/images/tapis-hotel-baronnie.jpg' },
  { title: 'Chambre haut de gamme', type: 'Moquette résidentielle sur mesure', sector: 'Résidentiel', year: '2025', surface: '45 m²', desc: "Moquette avec motif graphique pour une chambre privée. Choix du motif et des couleurs réalisé en showroom.", img: '/images/moquette-chambre-motif.jpg' },
  { title: 'Chambre résidentielle', type: 'Moquette résidentielle', sector: 'Résidentiel', year: '2025', surface: '35 m²', desc: "Moquette coloris bleu pour une chambre particulier. Conseil personnalisé en showroom sur la teinte et la texture.", img: '/images/moquette-chambre-bleu.jpg' },
]
