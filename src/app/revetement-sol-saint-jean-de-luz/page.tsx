...
const marques = [
  ...
  { name: "Gerflor", desc: "Le français de Lyon, qu'on connaît par cœur. Leurs gammes Mipolam et Texline encaissent l'humidité atlantique sans souci. Compatible chauffage au sol, entretien simple." },
...
const faq = [
  ...
  { q: "Combien de temps tient une moquette laine en front de mer ?", a: "Quinze à vingt ans facilement, même en climat atlantique. La laine vierge gère bien l'humidité ambiante, elle l'absorbe et la restitue sans s'altérer. Les synthétiques, eux, peuvent se déformer. Sur les vestibules et les escaliers, on choisit plutôt une laine tissée serrée avec un motif discret qui pardonne les passages. Un nettoyage pro en fin de saison avant l'hivernage suffit à garder l'aspect du premier jour." },
]
