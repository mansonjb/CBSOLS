...
const marques = [
  ...
  { name: "Tarkett", desc: "Pour les plateaux tertiaires qui demandent un vrai confort acoustique, on part sur du Tarkett iQ Granit. Il vieillit bien et reste également notre référence pour les zones humides hôtelières." },
