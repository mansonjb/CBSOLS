...
export const metadata: Metadata = {
  ...
  description: "Pose de sol PVC en collège et lycée, salles de cours, laboratoires sciences, CDI, ateliers. Conformité ERP type R, lés grande largeur soudés à chaud, marché public éducation. CB Sols, plus de 25 ans d'expérience.",
...
export default function SolPvcCollegeLyceePage() {
  ...
  return (
    <div style={{ paddingTop: '72px' }}>
      <StickyDevisButton from="college-lycee" />
