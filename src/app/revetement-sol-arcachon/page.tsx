...
const materiaux = [
  { name: "Moquette laine vierge tissée pour Ville d'Hiver", desc: "C'est notre matière de référence dans les villas Belle Époque. La laine se patine, elle ne s'écrase pas. Au toucher c'est ferme, à l'œil c'est noble. On choisit avec vous un uni profond ou un motif géométrique XIXe pour s'accorder aux boiseries d'origine. Quinze à vingt ans devant vous, sans souci." },
