...
const usages = [
  { title: "Villas familiales Ville d'Hiver et Pereire", desc: "Les villas du quartier Ville d'Hiver, classées remarquables, et celles de Pereire ou des Abatilles concentrent un patrimoine architectural Belle Époque et années 30. Salons d'apparat, chambres parentales, bibliothèques, vérandas tournées vers le Bassin. Moquette laine tissée à motif discret, tapis sur mesure dans les pièces de réception, coordination avec les parquets d'origine et les boiseries XIXe préservées. Nos poses respectent le bâti existant et son histoire." },
  { title: "Hôtels boutique face Bassin", desc: "Hôtels de charme, demeures hôtelières familiales, maisons d'hôtes de prestige le long du front de mer arcachonnais et au Moulleau. Chambres avec vue, suites avec terrasse, salons d'accueil. Moquette hôtellerie haute densité dans les chambres, tapis structurants dans les salons, finitions soignées qui posent la qualité du lieu dès l'entrée. Pose en basse saison pour ne pas perturber l'exploitation." },
  { title: "Restaurants bord de mer et tables réputées", desc: "Restaurants gastronomiques et tables iodées du Moulleau, de Pereire, du Pyla. Salles avec vue sur le Bassin, salons privés, espaces de réception. Moquette tissée traitée anti-tache, isolation acoustique pour préserver la conversation à table, palette en accord avec les bois flottés et l'horizon marin. Pose nocturne pour ne pas perdre un service." },
  { title: "Résidences secondaires et villas contemporaines", desc: "Le Pyla, les Abatilles, l'Aiguillon, Eyrac : résidences contemporaines, villas d'architectes, maisons d'été familiales. Sols PVC effet bois pour les pieds nus venus de plage, moquette sisal ou bouclée dans les chambres, tapis chinés dans les salons. Nous adaptons les matières au mode de vie balnéaire : sable, humidité, fenêtres ouvertes en permanence l'été." },
]

const exigences = [
  { title: "Caractère Belle Époque de Ville d'Hiver", desc: "La Ville d'Hiver d'Arcachon, c'est un patrimoine architectural unique : chalets suisses, villas mauresques, néo-gothiques, ramassées sur les dunes. Pose réversible chaque fois que possible pour ne pas abîmer les parquets d'origine, choix de coloris en cohérence avec les boiseries XIXe, coordination avec l'éventuel architecte du patrimoine quand le projet l'exige. La discrétion de l'intervention est ici une qualité majeure." },
  { title: "Front de mer et résidences contemporaines", desc: "Pereire, Le Moulleau, Le Pyla concentrent les villas contemporaines et les résidences d'architecte avec grandes baies sur le Bassin. Sols clairs qui captent la lumière marine, matières qui supportent le sable, l'humidité ambiante et le mode de vie pieds nus. La cohérence avec l'architecture moderne se travaille dans les choix d'unis mats et les bois flottés." },
  { title: "Saisonnalité des chantiers", desc: "Arcachon vit au rythme des saisons touristiques. Pour les villas familiales, les hôtels boutique et les restaurants, nous évitons systématiquement juillet et août, où l'occupation et la fréquentation sont maximales. La fenêtre idéale court d'octobre à avril, avec des pics d'activité en mars-avril et septembre-octobre. Nous planifions les chantiers très en amont pour caler les meilleurs créneaux." },
  { title: "Logistique depuis La Rochelle", desc: "Arcachon est à environ 250 kilomètres et 2h30 de route de notre atelier de Villedoux. Nous mobilisons une équipe complète qui reste sur place le temps du chantier, avec hébergement inclus dans le devis. Les matières sont préparées et pré-assemblées en atelier, ce qui permet de tenir une pose finale rapide une fois sur site, sans navettes inutiles entre Charente-Maritime et Bassin." },
  { title: "Matières qui tiennent l'humidité marine", desc: "L'air du Bassin est doux mais chargé en humidité. Les matières que nous proposons sont sélectionnées pour leur stabilité dans cet environnement : laines vierges traitées, sisals scellés, tissés vinyle Bolon qui supportent l'humidité sans gondoler, PVC effet bois pour les pièces directement exposées au sable et à l'eau. C'est un point que nous validons systématiquement à l'échantillonnage." },
  { title: "Coordination architectes Bassin", desc: "La scène architecture d'intérieur du Bassin est active, autour de Bordeaux, Cap Ferret, Arcachon. Nous travaillons régulièrement en sous-traitance de leurs prescriptions, avec échantillons envoyés directement à l'agence pour validation sous l'éclairage de référence du projet. La continuité de service entre rive nord (Cap Ferret) et rive sud (Arcachon, Pyla) est un atout pour les architectes qui mènent des projets multi-sites sur le Bassin." },
]
