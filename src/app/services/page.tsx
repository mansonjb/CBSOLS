...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://cbsols.fr/services' },
}
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '3rem', alignItems: 'center' }}>
              <div>
                ...
                <p style={{ fontSize: '0.95rem', color: 'var(--cream-muted)', lineHeight: 1.75, marginBottom: '1.75rem' }}>
                  Un entretien périodique prolonge la durée de vie d&apos;une moquette de 30 à 50 %. Hôtels, bureaux, restaurants : nous intervenons sans interrompre votre activité, avec contrats annuels possibles.
                </p>
