...
export const realisations: Realisation[] = [
  ...
  },
  {
    ...
    gallery: [
      { src: '/images/projects/pose-moquettes-sols-maison-de-maitre/05.jpg', caption: "Salle d'eau, moquette tissée à motifs baroques sur l'ensemble du sol" },
      { src: '/images/projects/pose-moquettes-sols-maison-de-maitre/01.jpg', caption: "Détail de la moquette bleue à fleurettes, sous un pied de chaise d'époque" },
      { src: '/images/projects/pose-moquettes-sols-maison-de-maitre/02.jpg', caption: "Zoom sur le motif tufté de la moquette posée à l'étage" },
      { src: '/images/projects/pose-moquettes-sols-maison-de-maitre/06.jpg', caption: "Chambre, moquette ornementale à motifs jaunes sur fond gris" },
      { src: '/images/projects/pose-moquettes-sols-maison-de-maitre/04.jpg', caption: "Salle de bain accessible depuis un couloir au parquet géométrique" },
      { src: '/images/projects/pose-moquettes-sols-maison-de-maitre/09.jpg', caption: "Cuisine longue, sol PVC effet parquet géométrique posé jusqu'à l'îlot marbre" },
      { src: '/images/projects/pose-moquettes-sols-maison-de-maitre/08.jpg', caption: "Détail de l'îlot cuisine et du sol PVC géométrique tout autour" },
      { src: '/images/projects/pose-moquettes-sols-maison-de-maitre/07.jpg', caption: "Couloir, sol PVC géométrique éclairé en lumière rasante" },
      { src: '/images/projects/pose-moquettes-sols-maison-de-maitre/10.jpg', caption: "Texture du sol PVC effet chêne en losanges, vue à la lumière naturelle" },
      { src: '/images/projects/pose-moquettes-sols-maison-de-maitre/03.jpg', caption: "Transition entre moquette de chambre et parquet géométrique, profilé laiton" },
    ],
  },
  {
    slug: 'renovation-longere-boisseuil',
    title: 'Rénovation longère 170 m², proche de La Rochelle',
    description: "Rénovation complète des sols d'une longère de 170 m² proche de La Rochelle : barrière anti-humidité, ragréage, trois designs de sols vinyle, calepinage pièce par pièce.",
    image: '/images/projects/renovation-longere-boisseuil/03.jpg',
    date: '2023-09-15',
    year: '2023',
    sector: 'Résidentiel particulier',
    location: 'Proche de La Rochelle',
    client: 'Particulier',
    type: 'Sols vinyle multi-design + ragréage',
    surface: '170 m²',
    body: [
      "Rénovation complète des sols d'une longère ancienne proche de La Rochelle, soit 170 m² répartis sur l'ensemble des pièces de vie. Le projet a démarré par la pose d'une barrière anti-humidité, indispensable sur ce type de support traditionnel en pierre, puis par un ragréage complet pour neutraliser les niveaux et atteindre la planéité requise pour la pose de sols vinyle.",
      "Trois designs différents de sols vinyle ont été choisis pour rythmer les espaces : un parquet effet chêne ancien dans le séjour et le couloir, un terrazzo gris foncé pour délimiter visuellement l'espace cuisine sans le fermer par une cloison, et une variante chêne plus claire en chambre. Les jonctions entre les différents motifs ont été coupées à la lame, sans seuil, pour préserver la continuité visuelle.",
      "La principale difficulté du projet venait du bâti d'origine : dans une longère ancienne, les murs ne sont jamais d'équerre. Chaque pièce a donc demandé une implantation sur mesure, pour que les lames terminent proprement contre les plinthes existantes sans donner l'impression d'un calepinage de travers. Le résultat conserve le caractère du lieu tout en lui apportant le confort, l'entretien facile et l'étanchéité du vinyle moderne.",
    ],
    gallery: [
      { src: '/images/projects/renovation-longere-boisseuil/03.jpg', caption: "Vue d'ensemble de l'espace cuisine et salle à manger, sol vinyle effet chêne ancien" },
      { src: '/images/projects/renovation-longere-boisseuil/01.jpg', caption: "Espace cuisine marqué par un design terrazzo, en transition avec le parquet vinyle de la salle à manger" },
      { src: '/images/projects/renovation-longere-boisseuil/05.jpg', caption: "Détail de la jonction coupée à la lame entre terrazzo et parquet, sans seuil" },
      { src: '/images/projects/renovation-longere-boisseuil/07.jpg', caption: "Plongée sur la zone terrazzo et la transition vers le parquet vinyle" },
      { src: '/images/projects/renovation-longere-boisseuil/06.jpg', caption: "Texture du terrazzo gris foncé, sous un pied de meuble ancien" },
      { src: '/images/projects/renovation-longere-boisseuil/04.jpg', caption: "Couloir entre les pièces, parquet vinyle posé en lames continues" },
      { src: '/images/projects/renovation-longere-boisseuil/02.jpg', caption: "Passage entre deux pièces, calepinage du parquet ajusté à un mur non d'équerre" },
    ],
  },
  {
