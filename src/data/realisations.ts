...
export const realisations: Realisation[] = [
  ...
  },
  {
    ...
    title: 'Rénovation longère 170 m², Boisseuil',
    description: "Rénovation complète des sols d'une longère de 170 m² à Boisseuil : barrière anti-humidité, ragréage, trois designs de sols vinyle, calepinage pièce par pièce.",
    ...
    surface: '170 m²',
    body: [
      "Rénovation complète des sols d'une longère ancienne à Boisseuil, soit 170 m² répartis sur l'ensemble des pièces de vie. Le projet a démarré par la pose d'une barrière anti-humidité, indispensable sur ce type de support traditionnel en pierre, puis par un ragréage complet pour neutraliser les niveaux et atteindre la planéité requise pour la pose de sols vinyle.",
