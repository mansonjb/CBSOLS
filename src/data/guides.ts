...
export const guides: Guide[] = [
  ...
  },
  {
    ...
    faq: [
      { q: "Quel sol pour une cuisine de restaurant ?", a: "Sol PVC homogène R11 minimum, soudé à chaud avec remontées en plinthes. Classement résistance chimique P2 minimum. Références : Gerflor Mipolam Granit, Bostik Eternal Natural ou Heterogeneous. CB Sols réalise le devis sur mesure après visite du site." },
