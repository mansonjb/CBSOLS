...
export const guides: Guide[] = [
  {
    ...
    faq: [
      { q: 'Quelle moquette pour un bureau open space ?', a: 'Pour un open space, optez pour une dalle de moquette classement 33, grammage 500-600 g/m², avec sous-couche intégrée pour le confort acoustique. Les dalles facilitent le remplacement en cas de détérioration localisée. EGE Carpets ou EGE sont de bonnes références.' },
  ...
  },
  {
    ...
    faq: [
      { q: "Quel sol pour une cuisine de restaurant ?", a: "Sol PVC homogène R11 minimum, soudé à chaud avec remontées en cuvette. Classement résistance chimique P2 minimum. Références : Gerflor Mipolam Granit, Bostik Eternal Natural ou Heterogeneous. CB Sols réalise le devis sur mesure après visite du site." },
