...
export const guides: Guide[] = [
  // Page tendance evergreen : pour la refresh en 2027, changer '2026' en '2027' dans title/metaTitle/intro,
  // bumper dateModified, et actualiser 1-2 points de tendance. L'URL reste inchangee pour accumuler l'autorite SEO.
  {
    slug: 'pourquoi-choisir-la-moquette',
    title: 'Pourquoi (re)mettre de la moquette chez soi en 2026',
    metaTitle: 'Pourquoi Choisir la Moquette en 2026 | Le Grand Retour',
    metaDescription: "Le retour de la moquette en deco 2026 : les vraies raisons de choisir la moquette maison, du confort acoustique a la chaleur. Le regard d'un artisan.",
    category: 'Guide Moquette',
    headline: 'Le grand retour de la moquette',
    intro: "Pendant des annees, la moquette a fait figure de ringardise absolue. On lui reprochait, non sans raison, les tapis synthetiques des annees 80 et 90 qui gardaient la poussiere, les odeurs et les mauvais souvenirs. Et puis le vent a tourne. En 2026, la moquette revient en force dans la deco, portee par le besoin de confort, de douceur et d'ambiances enveloppantes. Les magazines la remettent en couverture, les architectes d'interieur la reintegrent dans les chambres et les bureaux. Dans ce guide, nous allons voir pourquoi ce retour n'a rien d'un caprice de tendance, et pourquoi la moquette est aujourd'hui un choix pertinent, avec le regard d'un artisan qui en pose depuis plus de 25 ans. Sans langue de bois, ni survente.",
    sections: [
      {
        title: "Le confort acoustique, l'argument numero un",
        body: "S'il ne fallait retenir qu'une seule raison, ce serait celle-la. La moquette est le revetement de sol le plus performant pour attenuer les bruits. Concretement, une moquette absorbe entre 25 et 35 dB de bruits d'impact, c'est-a-dire les bruits de pas, les chutes d'objets, le raclement des chaises. Aucun sol dur, ni carrelage, ni parquet, ni sol PVC, n'approche ce niveau de performance sans sous-couche specifique.\n\nEn appartement, cet argument devient decisif. Vous connaissez peut-etre les pas du voisin du dessus qui resonnent toute la soiree. La moquette regle ce probleme a la source, chez celui qui la pose comme pour ceux d'en dessous. A l'etage d'une maison, dans une chambre d'enfant ou une salle de jeux, elle transforme radicalement l'ambiance sonore.\n\nCe silence feutre, difficile a decrire tant qu'on ne l'a pas vecu, change la sensation d'une piece. On parle moins fort, on se sent plus au calme. C'est un confort quotidien que les sols durs, malgre toutes leurs qualites, ne savent tout simplement pas offrir.",
      },
      {
        title: "De la chaleur sous les pieds, des economies au chauffage",
        body: "La moquette est un isolant thermique naturel. Ses fibres emprisonnent l'air, ce qui limite les deperditions de chaleur par le sol et renvoie une sensation de tiedeur permanente. Le matin, en hiver, vous posez le pied sur une surface accueillante plutot que sur un carrelage glace. Ce detail, apparemment anodin, pese lourd dans le confort ressenti au fil des mois.\n\nAu-dela de la sensation, il y a un vrai gain de ressenti thermique. Selon la piece et l'isolation existante, la moquette peut faire gagner quelques degres perçus, ce qui permet souvent de baisser un peu le thermostat sans avoir froid. Dans un contexte ou l'energie coute cher et ou chaque degre compte, ce n'est pas un argument marginal.\n\nCe benefice prend tout son sens dans les chambres et les pieces de vie orientees au nord, celles qui restent fraiches malgre le chauffage. La moquette y apporte une chaleur douce et constante, la ou un sol dur accentue au contraire la sensation de froid.",
      },
      {
        title: "Le cocooning, une tendance de fond",
        body: "Le retour de la moquette n'est pas un hasard de calendrier. Il accompagne un mouvement deco plus large, celui de la maison-refuge. Apres des annees de sols durs, de beton cire et de lignes minimalistes, l'envie a change de camp. On cherche desormais de la douceur, des matieres chaleureuses, des interieurs dans lesquels on a envie de se lover.\n\nLa moquette participe pleinement de cette ambiance enveloppante. Elle habille une piece, adoucit l'acoustique, rechauffe la lumiere. Une chambre entierement moquettee degage une intimite qu'un parquet, aussi beau soit-il, ne procure pas de la meme façon. Le carrelage froid, lui, envoie exactement le signal inverse.\n\nCe besoin de cocooning traverse toute la deco actuelle : textiles epais, teintes naturelles, matieres tactiles. La moquette coche toutes les cases. Elle n'est plus le sol par defaut qu'on subissait, elle redevient un choix esthetique assume, au service d'une atmosphere que l'on construit piece par piece.",
      },
      {
        title: "Plus sure pour les enfants et les seniors",
        body: "La securite est un argument souvent oublie, alors qu'il est parmi les plus concrets. La moquette amortit les chutes. Un enfant qui trebuche, un tout-petit qui apprend a marcher, tombe sur une surface souple plutot que sur un sol dur. La difference, en cas de choc a la tete ou au genou, est loin d'etre negligeable.\n\nElle est aussi naturellement antiderapante. Contrairement a un carrelage ou a un parquet vernis, qui deviennent glissants des qu'ils sont mouilles ou simplement sous des chaussettes, la moquette offre une accroche constante. Pas de glissade en sortant du lit, pas de derapage dans le couloir.\n\nCet aspect en fait un revetement particulierement adapte aux familles avec de jeunes enfants comme au maintien a domicile des personnes agees. Dans une chambre de senior, une moquette bien posee reduit le risque de chute et attenue la gravite de celles qui surviennent malgre tout. C'est un argument de securite reel, rarement mis en avant, et pourtant determinant pour bien des foyers.",
      },
      {
        title: "La qualite de l'air, le contre-pied qui surprend",
        body: "Voici l'idee reçue la plus tenace, et pourtant la plus a nuancer. On croit souvent que la moquette est l'ennemie des personnes allergiques. Les etudes racontent une histoire plus subtile. La moquette piege les poussieres et les allergenes dans ses fibres au lieu de les laisser circuler librement dans l'air, comme c'est le cas sur un sol dur ou le moindre courant d'air remet les particules en suspension.\n\nAutrement dit, ce qui est capture dans la moquette ne se retrouve pas dans vos poumons, a condition de l'aspirer regulierement avec un aspirateur adapte, idealement equipe d'un filtre HEPA. Avec un entretien serieux, une moquette moderne certifiee, portant les labels encadrant les emissions de COV, est compatible avec des personnes sensibles.\n\nSoyons honnetes sur la nuance : cela vaut pour les moquettes recentes, bien choisies et reellement entretenues. Une vieille moquette jamais nettoyee reste un mauvais choix. La technologie a change la donne, pas la negligence.",
      },
      {
        title: "Fini la moquette ringarde : la nouvelle generation",
        body: "Si votre image de la moquette date encore des tapis marron a longs poils de vos grands-parents, il est temps de la mettre a jour. Les moquettes d'aujourd'hui n'ont plus rien a voir avec celles des annees 90. Le design a completement change, et le resultat surprend souvent ceux qui redecouvrent la matiere en showroom.\n\nLes fabricants proposent des bouclees fines et graphiques, des veloutees profondes, des effets laine d'une grande elegance. Les coloris ont evolue vers des teintes naturelles et intemporelles : lin, sable, gris chine, taupe, avec des motifs discrets qui se fondent dans une deco contemporaine plutot que de l'ecraser.\n\nCes moquettes s'invitent aujourd'hui dans les endroits les plus soignes de la maison. Une chambre parentale gagne en intimite, un dressing en cachet, une bibliotheque ou un bureau en confort feutre propice a la concentration. Loin du cliche, la moquette moderne est devenue un vrai element de decoration, capable de signer une piece avec autant de caractere qu'un beau parquet.",
      },
      {
        title: "Durable et facile a vivre, si elle est bien posee",
        body: "Reste la question de la durabilite, souvent brandie contre la moquette. La encore, les choses ont evolue. Les moquettes contract modernes, celles conçues pour les usages exigeants, durent couramment 10 a 15 ans dans un cadre domestique. L'entretien, contrairement a une autre idee reçue, est simple : un aspirateur regulier suffit au quotidien, complete par un nettoyage professionnel une fois par an.\n\nMais il faut etre franc sur un point : tout se joue a la pose. Une moquette mal choisie pour son usage, ou posee a la va-vite sur un support mal prepare, se marquera, se decollera et vieillira mal. A l'inverse, une moquette bien selectionnee et bien posee tient parfaitement dans le temps. C'est precisement la que le savoir-faire fait la difference.\n\nChoisir le bon produit selon la piece, preparer le support, realiser une pose nette et durable : c'est le metier d'un poseur experimente. Chez CB Sols, artisan du revetement de sol pres de La Rochelle, c'est ce travail de conseil et de pose soignee que nous menons depuis plus de 25 ans.",
      },
    ],
    faq: [
      { q: "La moquette, ce n'est pas depasse en 2026 ?", a: "Non, c'est meme l'inverse. Apres des annees de sols durs, la moquette revient en force dans la deco 2026, portee par un besoin de confort, de douceur et d'ambiances chaleureuses. Les architectes d'interieur la reintegrent dans les chambres, les bureaux et les espaces de detente. Ce qui etait depasse, ce sont les moquettes synthetiques des annees 90, pas la moquette en tant que telle. La nouvelle generation, avec ses coloris naturels et ses matieres soignees, n'a plus rien a voir. C'est un choix deco assume, pas une survivance du passe." },
      { q: "La moquette est-elle compatible avec les allergies ?", a: "Oui, sous conditions, et c'est plus nuance qu'on ne le croit. Les etudes montrent que la moquette piege les poussieres et allergenes dans ses fibres au lieu de les laisser circuler dans l'air, comme sur un sol dur. Une moquette moderne certifiee, portant les labels qui encadrent les emissions de COV, associee a un aspirateur a filtre HEPA et a un entretien regulier, convient a la plupart des personnes sensibles. La nuance est importante : cela vaut pour les moquettes recentes et bien entretenues, pas pour une vieille moquette negligee." },
      { q: "Dans quelles pieces poser de la moquette ?", a: "La moquette est ideale dans les pieces ou l'on recherche confort, chaleur et silence : chambres, chambre parentale, dressing, bureau, bibliotheque, salle de jeux ou coin lecture. Elle y apporte une intimite et un confort acoustique qu'aucun sol dur n'egale. En revanche, mieux vaut l'eviter dans les pieces humides ou tres salissantes comme la cuisine et la salle de bains, ou un sol PVC ou du carrelage restent plus adaptes. Le bon revetement depend toujours de l'usage reel de la piece, et c'est le premier conseil qu'un artisan vous donnera." },
      { q: "Combien de temps dure une moquette aujourd'hui ?", a: "Une moquette moderne de qualite, du type contract, dure couramment 10 a 15 ans dans un logement, a condition d'etre bien entretenue. L'entretien est simple : un passage d'aspirateur regulier au quotidien et un nettoyage professionnel une fois par an suffisent a preserver son aspect et ses fibres. La duree de vie depend surtout de deux facteurs : la qualite du produit choisi selon la piece, et le soin apporte a la pose. Une moquette bien selectionnee et bien posee vieillit nettement mieux qu'un produit d'entree de gamme installe a la hate." },
      { q: "Peut-on poser de la moquette sur un carrelage existant ?", a: "Oui, c'est possible sous conditions, et c'est souvent une bonne solution pour eviter une depose couteuse. Le carrelage doit etre propre, plan, sans carreaux decolles ni fissures, et bien ancre. Les joints creux et les eventuels defauts de planeite doivent parfois etre repris au prealable pour garantir un rendu net et durable. Selon le type de moquette et l'etat du support, on procede par collage ou avec une sous-couche adaptee. Chaque situation etant differente, le mieux reste de faire evaluer votre support par un professionnel avant de vous lancer." },
    ],
    relatedSolutions: ['moquette-bureau', 'moquette-hotel', 'moquette-collectivite'],
  ...
  },
  {
    ...
    intro: "Une moquette professionnelle bien entretenue dure deux fois plus longtemps qu'une moquette mal entretenue. Ce guide détaille les méthodes, fréquences et erreurs à éviter pour maximiser votre investissement. Au-delà de la moquette, il couvre désormais l'entretien du sol PVC professionnel et des tapis sur mesure en fibres naturelles (laine, sisal, jonc de mer), ainsi que les erreurs courantes qui ruinent un sol en moins d'un an.",
    sections: [
      {
      ...
      },
      {
        ...
        body: "Le sol PVC professionnel demande un entretien spécifique, différent de la moquette. Aspiration quotidienne des zones passantes (couloirs, accueil, open spaces) avec un aspirateur professionnel à embout brosse douce, pour éliminer les poussières et particules abrasives qui rayent la surface dans le temps.\n\nLavage à plat à l'eau tiède additionnée d'un détergent neutre pH 7-8, à fréquence hebdomadaire en tertiaire, quotidienne en cuisines professionnelles ou établissements de santé. Le matériel : balai trapèze avec frange microfibre, ou autolaveuse pour les grandes surfaces. Rinçage à l'eau claire systématique pour éviter les résidus collants.\n\nNe JAMAIS utiliser de solvants, d'alcool ou d'eau de javel pure : ces produits attaquent les plastifiants du PVC, le rendent cassant et tachent la surface définitivement. Pour les soudures à chaud entre lés, brosse douce 1 fois par mois pour déloger les salissures dans la rainure.\n\nEn zone à trafic intense (couloirs d'hôpitaux, halls d'accueil), prévoir une métallisation tous les 2 à 3 ans : application d'un émulsion polymère qui ravive l'aspect d'origine, comble les micro-rayures et prolonge la durée de vie du revêtement de plusieurs années.",
      },
      {
        title: "L'entretien des tapis sur mesure (laine, sisal, jonc de mer)",
        body: "Les tapis sur mesure en fibres naturelles demandent un entretien adapté à chaque fibre, sous peine de les détruire en quelques mois.\n\nLaine : brossage régulier dans le sens des fibres avec une brosse douce, aspiration hebdomadaire sans brosse rotative pour ne pas casser les fibres, nettoyage à sec annuel par un professionnel (poudre absorbante puis aspiration). Pour une tache, intervention IMMÉDIATE : tamponner avec un chiffon propre imbibé d'eau froide en partant de l'extérieur vers le centre. Jamais d'eau chaude qui fixe les protéines de la laine, jamais de javel ni d'ammoniaque.\n\nSisal : nettoyage à sec UNIQUEMENT. Le sisal ne supporte PAS l'eau : il rétrécit, gondole et se déforme irréversiblement à la moindre humidité importante. Aspiration douce sans rotation, traitement des taches avec une mousse à sec spécifique sisal, jamais en mouillant.\n\nJonc de mer : la fibre la plus tolérante, supporte une légère humidité ambiante (8-12% recommandés pour préserver sa souplesse). Brumisation occasionnelle d'eau claire en zone très sèche, aspiration hebdomadaire, traitement des taches avec un chiffon humide essoré.\n\nRègle d'or absolue : AUCUN nettoyeur vapeur sur fibres naturelles. La vapeur sous pression désorganise les fibres et fait fondre les liants des tapis à fond gommé.",
      },
      {
        title: "Les 6 erreurs qui ruinent un sol en 1 an",
        body: "(1) Solvants ou alcool sur un sol PVC : attaquent les plastifiants, le sol devient cassant et tache irrémédiablement. Conséquence : remplacement complet sous 12 à 18 mois alors qu'un PVC bien entretenu dure 20 ans.\n\n(2) Eau de javel pure : décolore le PVC, brûle la laine d'une moquette ou d'un tapis, attaque les soudures à chaud des lés. À diluer impérativement (1 volume pour 10) et à n'utiliser que ponctuellement sur taches résistantes.\n\n(3) Nettoyeur vapeur sur jonc de mer ou sisal : la vapeur désorganise la fibre, le tapis gondole et se déforme. Le dégât est immédiat et irréversible.\n\n(4) Trop d'eau sur les soudures d'un sol PVC : l'eau s'infiltre dans la rainure mal soudée ou usée, décolle le sol par capillarité, favorise les moisissures sous le revêtement. Lavage à plat humide essoré, jamais à grande eau.\n\n(5) Aspirateur à brosse rotative sur une moquette laine : la brosse arrache les fibres, ouvre les boucles, fait peluche en quelques semaines. Embout brosse douce ou aspirateur sans rotation obligatoire.\n\n(6) Délai trop long avant traitement d'une tache : au-delà de 2 heures, une tache de vin, café, sang ou encre devient quasi-impossible à rattraper. Le bon réflexe : kit de détachants accessible à toute l'équipe, intervention dans les 5 à 10 minutes après l'incident.",
      },
    ],
    faq: [
      ...
      { q: "Peut-on utiliser un nettoyeur vapeur sur un sol PVC ?", a: "Pas sur les soudures à chaud entre lés : la vapeur sous pression peut décoller la rainure, infiltrer de l'eau sous le revêtement et provoquer des cloques. Sur la masse du sol (lé entier sans joint), c'est possible avec parcimonie : maximum 2 à 3 fois par an, température 100°C maximum, passage rapide sans stationner, séchage immédiat avec chiffon microfibre. Pour un entretien régulier, préférer le lavage à plat à l'eau tiède + détergent neutre pH 7-8, beaucoup plus sûr." },
      { q: "Comment enlever une tache de vin sur moquette ?", a: "Intervention immédiate impérative : éponger le surplus avec un chiffon propre par tamponnement (jamais en frottant, ce qui étale la tache et abîme les fibres). Puis appliquer un mélange eau froide + savon blanc liquide (type Marseille), tamponner en partant de l'extérieur vers le centre. Rincer avec un chiffon imbibé d'eau froide. Si la tache résiste, passer une solution de vinaigre blanc dilué (1 cuillère à soupe dans 1 litre d'eau froide). Surtout PAS d'eau chaude, qui fixe le tanin du vin sur la fibre et rend la tache quasi-impossible à enlever ensuite. Le sel n'est efficace que dans les toutes premières secondes." },
      { q: "Faut-il imperméabiliser une moquette neuve ?", a: "Sur moquette laine, oui : traitement Scotchgard ou équivalent (3M, Teflon Carpet Protector) appliqué après la pose et après chaque nettoyage en profondeur. Ce traitement crée une barrière invisible qui repousse les liquides et facilite l'absorption des taches dans les premières secondes. À refaire tous les 2 à 3 ans selon le trafic. Coût : 2 à 4 €/m². Sur moquette synthétique polyamide (PA) ou polypropylène (PP), le traitement est inutile : ces fibres sont déjà traitées en usine avec une protection intégrée qui dure toute la vie du produit. Vérifier la fiche technique avant tout achat de traitement complémentaire." },
    ],
    relatedSolutions: ['moquette-hotel', 'moquette-bureau'],
  ...
  },
  {
    ...
    faq: [
      { q: "Faut-il toujours un ragréage avant la pose d'un sol ?", a: "Dans 99 % des projets de rénovation, oui. Le ragréage garantit la planéité requise par le DTU 53.12 pour la pose d'un revêtement souple. Sans ragréage, les défauts du support remonteront à travers le revêtement en quelques mois. Même sur chape neuve, une réception de support est nécessaire (ponçage de la chape obligatoire par le lot chape)." },
