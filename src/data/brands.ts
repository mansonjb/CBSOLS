...
export const brands: Brand[] = [
  ...
  },
  {
    ...
    country: 'France',
    logoSrc: '/images/brands/balsan.webp',
    metaTitle: 'Balsan | Moquette Professionnelle, Revendeur CB Sols Charente-Maritime',
    metaDescription: 'CB Sols revendeur Balsan en Charente-Maritime. Moquettes bureaux, hôtels de la marque française de référence. Showroom Villedoux. Devis gratuit.',
    ...
    expertise: [
      ...
      'Revêtements établissements de santé',
    ...
    topCollections: [
      ...
      { name: 'Balsan Health', desc: 'Gamme établissements de santé : bactériostatique, résistante aux fauteuils roulants', useCases: 'cliniques, maisons de retraite' },
    ],
  ...
  },
  {
    ...
    logoSrc: '/images/brands/interface.webp',
