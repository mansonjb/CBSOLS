...
export const architectePartners: ClientReference[] = [
  ...
  { src: '/images/clients/StudioMaestria.png', alt: 'Studio Maëstria — Architecture Intérieure (anciennement Agnès Magord)', href: 'https://agnes-magord.fr/' },
  { src: '/images/clients/LaurentGuillon.png', alt: 'Laurent Guillon Architecte' },
