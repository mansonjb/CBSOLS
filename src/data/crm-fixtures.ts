...
export const leads: Lead[] = [
  ...
  },
  {
    ...
    segment: 'particulier',
    notes: [
      { date: '2026-04-27T08:30:00', content: "Visite chez la cliente. Salon 24 m², parquet existant. Choix d'un motif EGE Sense, coloris naturel.", auteur: 'VP' },
  ...
  },
  {
    ...
    notes: [
      ...
      { date: '2026-04-15T10:30:00', content: "Visite technique. Recommandé EGE Hospitality Acoustic.", auteur: 'VP' },
...
export const clients: Client[] = [
  ...
  {
    id: 'C-002',
    nom: 'Restaurant gastronomique 3★',
    type: 'pro',
    entreprise: 'SARL Restaurant Gastronomique',
    segment: 'restaurant',
    contact_principal: 'Direction restaurant',
    telephone: '05 46 41 48 19',
    email: 'direction@restaurant-3etoiles.fr',
...
export const chantiers: Chantier[] = [
  {
    ...
    marque_principale: 'objectflor Polyflor',
  ...
  },
  {
    ...
    marque_principale: 'EGE Hospitality Acoustic',
