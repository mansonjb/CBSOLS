...
/**
 * Avis Google vérifiés, transcrits depuis la fiche établissement CB Sols.
 * Textes laissés tels quels (verbatim client) — y compris les éventuelles
 * fautes d'orthographe et particularismes d'écriture.
 */
export const avis: Avis[] = [
  {
    name: "Audrey Chaigneau",
    context: "Particulier · maison",
    date: "il y a 7 mois",
  ...
  },
  {
    ...
    context: "Particulier · client récurrent",
    date: "il y a 5 mois",
  ...
  },
  {
    ...
    context: "Particulier · sols complets",
    date: "il y a un an",
  ...
  },
  {
    ...
    context: "Particulier · rénovation",
    date: "il y a un an",
  ...
  },
  {
    ...
    context: "Professionnel · nouvelle salle",
    date: "il y a un an",
  ...
  {
    name: "fabien chaigne",
    context: "Particulier · nettoyage tapis",
    date: "il y a 2 ans",
  ...
  },
  {
    ...
    context: "Particulier · rénovation demeure ancienne",
    date: "il y a 2 ans",
  ...
  {
    name: "Alexandre Depraetere",
    context: "Particulier · chambres (recul 4 ans)",
    date: "il y a 3 ans",
    text: "Nous avons fait refaire le revêtement de nos chambres par l'entreprise Bariteau . Une belle prestation et un revêtement de qualité professionnelle. 4 ans après c'est toujours comme neuf.",
  },
]
