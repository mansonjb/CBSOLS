...
export const faqs: Faq[] = [
  ...
  },
  {
    ...
    category: 'Sol PVC',
    shortAnswer: "Oui. Le PVC professionnel en lés soudés à chaud (Gerflor Taralay, objectflor) est 100% étanche, antidérapant R10 ou R11 selon la gamme, et nettement moins froid qu'un carrelage. C'est une excellente alternative pour une salle de bains de particulier.",
    sections: [
      {
