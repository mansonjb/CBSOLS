...
export const solutions: Solution[] = [
  ...
  {
    slug: 'sol-pvc-hotel',
    title: 'Sol PVC Hôtel | Espaces Communs & Circulations',
    metaTitle: 'Sol PVC Hôtel Charente-Maritime | Couloirs, Spa, Espaces Communs',
    metaDescription: 'Sol PVC pour hôtels en Charente-Maritime : couloirs, spa, espaces communs. CB Sols, esthétique premium, pose sans fermeture. Devis gratuit.',
    serviceSlug: 'sol-pvc-les',
    serviceName: 'Sol PVC',
    sectorSlug: 'hotellerie',
    sectorName: 'Hôtellerie',
    headline: 'Sol PVC pour hôtels',
    tagline: 'Élégance et résistance dans tous les espaces',
    intro: "Si la moquette règne dans les chambres et couloirs hôteliers, le PVC s'impose dans les espaces spa, les cuisines, les espaces de service et les circulations à fort trafic. CB Sols combine moquette et PVC dans une même intervention pour un résultat cohérent et parfaitement adapté à chaque zone de votre établissement.",
    specificChallenges: [
      'Résistance à l\'humidité constante (spa, zones service)',
      'Esthétique premium assortie à la décoration de l\'hôtel',
      'Antidérapance dans les zones humides',
    ...
    faq: [
      { q: 'Combien de temps prend la pose d\'un sol PVC dans un hôtel en activité ?', a: "Pour un hôtel en activité, nous travaillons par zones ou en rotation. Une circulation de 50 m² se pose en 1 à 2 jours hors séchage, sans fermeture. Pour un spa ou une cuisine, prévoir 2 à 3 jours selon la surface, idéalement programmés sur des journées de fermeture. Nous adaptons toujours le planning au calendrier de votre établissement." },
    ],
  },
  {
