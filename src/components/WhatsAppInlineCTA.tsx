  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: '200px' }}>
        <div style={{ fontFamily: 'var(--font-sans)', fontSize: '0.95rem', fontWeight: 700, color: 'var(--dark)', marginBottom: '0.25rem' }}>
          Un devis express sur WhatsApp ?
        </div>
        <div style={{ fontSize: '0.8rem', color: 'var(--text-muted)', lineHeight: 1.5 }}>
          Envoyez-nous quelques lignes sur votre projet, réponse dans la journée.
        </div>
      </div>
      <a
        href={href}
