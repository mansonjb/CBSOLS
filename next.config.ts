...
const csp = [
  ...
  "img-src 'self' data: blob: https://*.googletagmanager.com https://*.google-analytics.com https://*.clarity.ms https://c.bing.com https://www.google.com https://www.google.fr https://googleads.g.doubleclick.net https://*.doubleclick.net https://*.tile.openstreetmap.org https://vumbnail.com https://i.vimeocdn.com",
  "connect-src 'self' https://*.google-analytics.com https://www.google-analytics.com https://*.analytics.google.com https://*.googletagmanager.com https://www.google.com https://www.google.fr https://www.googleadservices.com https://googleads.g.doubleclick.net https://*.doubleclick.net https://*.clarity.ms https://www.clarity.ms https://c.bing.com https://api.openstreetmap.org https://nominatim.openstreetmap.org https://player.vimeo.com https://*.vimeocdn.com",
